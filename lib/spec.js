...
module.exports = function (files, options) {
  ...
  if (
    options.patches &&
    Array.isArray(options.patches) &&
    options.patches.length > 0
  ) {
  ...
  if (
    options.provides &&
    Array.isArray(options.provides) &&
    options.provides.length > 0
  ) {
  ...
  if (
    options.excludeArchs &&
    Array.isArray(options.excludeArchs) &&
    options.excludeArchs.length > 0
  ) {
    b.push("ExcludeArch: " + options.excludeArchs.join(", "));
  }

  if (
    options.exclusiveArchs &&
    Array.isArray(options.exclusiveArchs) &&
    options.exclusiveArchs.length > 0
  ) {
  ...
  if (
    ...
    Array.isArray(options.buildRequires) &&
    options.buildRequires.length > 0
  ) {
  ...
  if (
    options.prepScript &&
    Array.isArray(options.prepScript) &&
    options.prepScript.length > 0
  ) {
    b.push("%prep");
  ...
  if (
    options.buildScript &&
    Array.isArray(options.buildScript) &&
    options.buildScript.length > 0
  ) {
    b.push("%build");
  ...
  if (
    ...
    Array.isArray(options.installScript) &&
    options.installScript.length > 0
  ) {
    b.push("%install");
  ...
  if (
    options.checkScript &&
    Array.isArray(options.checkScript) &&
    options.checkScript.length > 0
  ) {
    b.push("%check");
  ...
  if (
    options.cleanScript &&
    Array.isArray(options.cleanScript) &&
    options.cleanScript.length > 0
  ) {
    b.push("%clean");
  ...
  if (
    ...
    Array.isArray(options.preInstallScript) &&
    options.preInstallScript.length > 0
  ) {
    b.push("%pre");
  ...
  if (
    ...
    Array.isArray(options.postInstallScript) &&
    options.postInstallScript.length > 0
  ) {
    b.push("%post");
  ...
  if (
    ...
    Array.isArray(options.preUninstallScript) &&
    options.preUninstallScript.length > 0
  ) {
    b.push("%preun");
  ...
  if (
    ...
    Array.isArray(options.postUninstallScript) &&
    options.postUninstallScript.length > 0
  ) {
    b.push("%postun");
  ...
  if (
    ...
    Array.isArray(options.verifyScript) &&
    options.verifyScript.length > 0
  ) {
    b.push("%verifyscript");
  ...
  _.forEach(files, function (file) {
    var directive =
      typeof file.directive === "undefined" ? "" : "%" + file.directive + " ";
    b.push(directive + '"' + file.path + '"');
  });

  if (
    options.changelog &&
    Array.isArray(options.changelog) &&
    options.changelog.length > 0
  ) {
    b.push("");
    b.push("%changelog");

    options.changelog.forEach(function (entry, index) {
      if (index > 0) {
        b.push("");
      }
